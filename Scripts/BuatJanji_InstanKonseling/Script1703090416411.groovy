...
Mobile.tap(findTestObject('BuatJanji_InstanKonseling/android.widget.Button (2)'), 0)

Mobile.tap(findTestObject('Object Repository/BuatJanji_InstanKonseling/android.widget.Button (3)'), 0)
