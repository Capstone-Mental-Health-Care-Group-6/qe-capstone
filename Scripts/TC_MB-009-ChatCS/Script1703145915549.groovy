...
Mobile.tap(findTestObject('Object Repository/ChatCS/android.widget.Button'), 0)

Mobile.tap(findTestObject('Object Repository/ChatCS/android.widget.Button (1)'), 0)

Mobile.sendKeys(findTestObject('Object Repository/ChatCS/android.widget.EditText'), 'laras1@gmail.com')

Mobile.tap(findTestObject('Object Repository/ChatCS/android.widget.EditText'), 0)

Mobile.sendKeys(findTestObject('Object Repository/ChatCS/android.widget.EditText'), 'laras1@gmail.com')

Mobile.hideKeyboard()

Mobile.tap(findTestObject('Object Repository/ChatCS/android.widget.EditText (1)'), 0)

Mobile.sendKeys(findTestObject('Object Repository/ChatCS/android.widget.EditText (1)'), 'laras1')
