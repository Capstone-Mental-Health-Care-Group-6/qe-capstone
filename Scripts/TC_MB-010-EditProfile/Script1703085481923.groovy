...
Mobile.tap(findTestObject('Object Repository/EditProfile/android.view.View'), 0)

Mobile.tap(findTestObject('Object Repository/EditProfile/android.view.View (1)'), 0)

Mobile.tap(findTestObject('Object Repository/EditProfile/android.view.View (2)'), 0)

Mobile.tap(findTestObject('Object Repository/EditProfile/android.view.View (2)'), 0)

Mobile.tapAndHold(findTestObject('Object Repository/EditProfile/android.view.View (3)'), 0, 0)
