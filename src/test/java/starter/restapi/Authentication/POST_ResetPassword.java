...
public class POST_ResetPassword {
    ...
    public String valid_url_ForgetPassword = "localhost:8000/reset-password?token_reset_password=8177";
    public String invalid_url_ForgetPassword = "localhost:8000/reset-password?token_reset_password=";
    ...
    public String RequestToAInvalidEndpointForTheResetPasswordEndpoint() {
        return invalid_url_ForgetPassword;
    }
    ...
    public void RequestToTheResetPasswordEndpointWithAnInvalidToken() {
        SerenityRest.given()
                .header("Content-Type", "application/json")
                .body("{}") // Tambahkan body yang valid jika diperlukan
